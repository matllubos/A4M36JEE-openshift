...
public class ObjectFactory {
    ...
    private final static QName _Find_QNAME = new QName( "http://flight.service.aos.fel.cvut.cz/", "find" );
    ...
    @XmlElementDecl( namespace = "http://flight.service.aos.fel.cvut.cz/", name = "findFlightsFrom" )
    ...
    @XmlElementDecl( namespace = "http://flight.service.aos.fel.cvut.cz/", name = "find" )
    ...
    @XmlElementDecl( namespace = "http://flight.service.aos.fel.cvut.cz/", name = "findFlights" )
    ...
    @XmlElementDecl( namespace = "http://flight.service.aos.fel.cvut.cz/", name = "findFlightsFromResponse" )
