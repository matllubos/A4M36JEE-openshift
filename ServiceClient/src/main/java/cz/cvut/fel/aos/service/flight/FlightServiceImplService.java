...
@WebServiceClient( name = "FlightServiceImplService",
        wsdlLocation = "http://localhost:8080/FlightService?wsdl",
        targetNamespace = "http://flight.service.aos.fel.cvut.cz/" )
public class FlightServiceImplService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName( "http://flight.service.aos.fel.cvut.cz/", "FlightServiceImplService" );

    public final static QName FlightServiceImplPort = new QName( "http://flight.service.aos.fel.cvut.cz/", "FlightServiceImplPort" );

    static {
        URL url = null;
        try {
            url = new URL( "http://localhost:8080/FlightService?wsdl" );
        } catch ( MalformedURLException e ) {
            System.err.println( "Can not initialize the default wsdl from http://localhost:8080/FlightService?wsdl" );
            // e.printStackTrace();
        }
        WSDL_LOCATION = url;
    }
