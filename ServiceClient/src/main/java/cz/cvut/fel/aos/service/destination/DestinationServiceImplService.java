...
@WebServiceClient(name = "DestinationServiceImplService", 
                  ...
                  targetNamespace = "http://destination.service.bookingserver.aos.fel.cvut.cz/") 
public class DestinationServiceImplService extends Service {

    public final static URL WSDL_LOCATION;
    public final static QName SERVICE = new QName("http://destination.service.bookingserver.aos.fel.cvut.cz/", "DestinationServiceImplService");
    public final static QName DestinationServiceImplPort = new QName("http://destination.service.bookingserver.aos.fel.cvut.cz/", "DestinationServiceImplPort");
    static {
        URL url = null;
        try {
