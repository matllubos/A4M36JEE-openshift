...
public interface PaymentService {
    ...
    @RequestWrapper( localName = "transferFromReservation", targetNamespace = "http://payment.service.payment.aos.fel.cvut.cz/", className = "cz.cvut.fel.aos.service.payment.TransferFromReservation" )
    @WebMethod
    @ResponseWrapper( localName = "transferFromReservationResponse", targetNamespace = "http://payment.service.payment.aos.fel.cvut.cz/", className = "cz.cvut.fel.aos.service.payment.TransferFromReservationResponse" )
    ...
    @WebResult( name = "return", targetNamespace = "" )
    @RequestWrapper( localName = "payVisa", targetNamespace = "http://payment.service.payment.aos.fel.cvut.cz/", className = "cz.cvut.fel.aos.service.payment.PayVisa" )
    @WebMethod
    @ResponseWrapper( localName = "payVisaResponse", targetNamespace = "http://payment.service.payment.aos.fel.cvut.cz/", className = "cz.cvut.fel.aos.service.payment.PayVisaResponse" )
