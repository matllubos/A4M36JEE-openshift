...
public interface ReservationService {
    ...
    /** najde rezervaci s daým číslem. Kontroluje oprávnění přístupu heslem v podobně
     * SHA-1 */
    Reservation find( long reservation, String password ) throws SecurityException;

    /** vytvoří rezervaci na let pro daný počet míst. Nastaví i heslo pro přístup v
     * podobě SHA-1 */
    ...
    /** vybere peníze vložené na zrušenou rezervaci. Lze použít pro platbu jiné
     * rezervace */
